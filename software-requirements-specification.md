...
1. 용어 및 약어 정의(Definitions, acronyms and abbreviations)
...
1. 프로젝트 결과물 전망(Product perspective)
    ...
    1. 사이트 적용 요건(Site adaption requirements)
...
1. 논리적 데이터베이스 요구사항(Logical database requirements)
...
1. 설계 제약사항(Design constraints)
    ...
    1. 표준 준수(Standards compliance)
        ...
        >   1. Audit tracing
1. 소프트웨어 시스템 속성(Software system attributes)
...
>- 지원 정보는 SRS를 더욱 사용하기 쉽게 한다.
1. Table of contents and index(목차와 인덱스)
